...
import { Currency, Token, TradeType, Pool, Protocol } from "@votopia/sdk-core";
...
export declare abstract class BaseQuoter<CandidatePools extends V3CandidatePools | [V3CandidatePools], Route extends V3Route> {
    ...
    constructor(tokenProvider: ITokenProvider, protocol: Protocol, blockedTokenListProvider?: ITokenListProvider, tokenValidatorProvider?: ITokenValidatorProvider);
    /**
