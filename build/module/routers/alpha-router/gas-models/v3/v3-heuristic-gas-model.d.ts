...
export declare class V3HeuristicGasModelFactory extends IOnChainGasModelFactory {
    constructor();
    buildGasModel({ gasPriceWei, pools, amountToken, quoteToken, l2GasDataProvider, providerConfig, }: BuildOnChainGasModelFactoryType): Promise<IGasModel<V3RouteWithValidQuote>>;
    private estimateGas;
    /**
