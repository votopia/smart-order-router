...
import { IL2GasDataProvider, OptimismGasData } from "../../../providers/v3/gas-data-provider";
import { CurrencyAmount } from "../../../util/amounts";
import { RouteWithValidQuote, V3RouteWithValidQuote } from "../entities/route-with-valid-quote";
export declare const usdGasTokens: Token[];
...
export declare abstract class IOnChainGasModelFactory {
    abstract buildGasModel({ gasPriceWei, pools, amountToken, quoteToken, l2GasDataProvider, providerConfig, }: BuildOnChainGasModelFactoryType): Promise<IGasModel<V3RouteWithValidQuote>>;
}
