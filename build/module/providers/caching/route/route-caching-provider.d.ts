...
export declare abstract class IRouteCachingProvider {
     ...
     * @param blockNumber
     */
    readonly getCachedRoute: (amount: CurrencyAmount<Currency>, quoteToken: Token, tradeType: TradeType, protocols: Protocol[], blockNumber: number, optimistic?: boolean) => Promise<CachedRoutes | undefined>;
    /**
    ...
    /**
     * Returns the CacheMode for the given combination, tokenIn, tokenOut and tradetype
     *
     * @public
     * @abstract
     * @param tokenIn
     ...
     * @param amount
     */
    abstract getCacheMode(amount: CurrencyAmount<Currency>, quoteToken: Token, tradeType: TradeType, protocols: Protocol[]): Promise<CacheMode>;
     ...
     * @protected
     */
    protected abstract _getCachedRoute(amount: CurrencyAmount<Currency>, quoteToken: Token, tradeType: TradeType, protocols: Protocol[], currentBlockNumber: number, optimistic: boolean): Promise<CachedRoutes | undefined>;
    /**
